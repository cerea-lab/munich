...
C------------------------------------------------------------------------
      ...
      subroutine jacdchemdc_leighton               (
...
C     Conversion mug/m3 to molecules/cm3.
      ...
      call dratedc_leighton               (
     $    ns,nr,rk,conc,dw)
 
      JacC( 49, 52) = JacC( 49, 52) + dw(  1, 52)
      JacC( 51, 52) = JacC( 51, 52) + dw(  1, 52)
      JacC( 52, 52) = JacC( 52, 52) - dw(  1, 52)
      JacC( 49, 49) = JacC( 49, 49) - dw(  2, 49)
      JacC( 50, 49) = JacC( 50, 49) + dw(  2, 49)
      JacC( 50, 50) = JacC( 50, 50) - dw(  3, 50)
      JacC( 50, 51) = JacC( 50, 51) - dw(  3, 51)
      JacC( 51, 50) = JacC( 51, 50) - dw(  3, 50)
      JacC( 51, 51) = JacC( 51, 51) - dw(  3, 51)
      JacC( 52, 50) = JacC( 52, 50) + dw(  3, 50)
      JacC( 52, 51) = JacC( 52, 51) + dw(  3, 51)
