...
#ifndef POLYPHEMUS_FILE_OUTPUT_SAVER_SAVERUNITSTREETSURFACEDRYDEPOSITIONRATE_AER_HXX
...
namespace Polyphemus
{
  ...
  class SaverUnitStreetSurfaceDryDepositionRate_aer: public BaseSaverUnit<T, ClassModel>
  {
  ...
  protected:
    ...
    vector<vector<Data<T, 1> > > Concentration_aer_;
  ...
  public:
    ...
    virtual ~SaverUnitStreetSurfaceDryDepositionRate_aer();
...
#define POLYPHEMUS_FILE_OUTPUT_SAVER_SAVERUNITSTREETSURFACEDRYDEPOSITIONRATE_AER_HXX
#endif
