...
#ifndef POLYPHEMUS_FILE_OUTPUT_SAVER_SAVERUNITSTREETWETDEPOSITION_HXX
...
namespace Polyphemus
{
  ...
  class SaverUnitStreetWetDeposition: public BaseSaverUnit<T, ClassModel>
  {
  ...
  protected:
    ...
    Data<T, 2> StreetScavengingFlux_; // ug/m2/s
    Data<T, 2> StreetScavengingRate_; // ug/s
  ...
  public:
    ...
    virtual ~SaverUnitStreetWetDeposition();
...
#define POLYPHEMUS_FILE_OUTPUT_SAVER_SAVERUNITSTREETWETDEPOSITION_HXX
#endif
