...
#ifndef POLYPHEMUS_FILE_OUTPUT_SAVER_SAVERUNITSTREETWASHOFFRATE_HXX
...
namespace Polyphemus
{
  ...
  class SaverUnitStreetWashoffRate: public BaseSaverUnit<T, ClassModel>
  {
  ...
  public:
    ...
    virtual ~SaverUnitStreetWashoffRate();
...
#define POLYPHEMUS_FILE_OUTPUT_SAVER_SAVERUNITSTREETWASHOFFRATE_HXX
#endif
