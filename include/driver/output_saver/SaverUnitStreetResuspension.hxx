...
#ifndef POLYPHEMUS_FILE_OUTPUT_SAVER_SAVERUNITSTREETRESUSPENSION_HXX
...
namespace Polyphemus
{
  ...
  class SaverUnitStreetResuspension: public BaseSaverUnit<T, ClassModel>
  {
  ...
  public:
    ...
    virtual ~SaverUnitStreetResuspension();
...
#define POLYPHEMUS_FILE_OUTPUT_SAVER_SAVERUNITSTREETRESUSPENSION_HXX
#endif
