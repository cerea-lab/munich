#ifndef POLYPHEMUS_FILE_MODELS_STREETTRANSPORTINERTPARTICLE_CXX

#include "StreetTransportInertParticle.hxx"
...
namespace Polyphemus
{
  ...
  Street<T>::Street(int street_id,
    ...
    length_(length), width_(width), height_(height), is_tunnel_(is_tunnel), ns_local_(ns_local)
  {
    ...
    street_surface_deposited_mass_.resize(ns_local_);
    street_surface_deposited_mass_ = 0.0;
    ...
    washoff_factor_.resize(ns_local_);
    washoff_factor_ = 0.0;
  ...
  */
  template<class T>
  inline void Street<T>::SetMeteoChemistry(T attenuation,
					   T specific_humidity)
  {
    throw string("\"Street<T>::SetMeteoChemistry(T attenuation, T specific_humidity)\"")
      + " is not defined.";
  }
  ...
  */
  ...
  {
    throw string("\"StreetAerosol<T>::SetRelativeHumidity()\"")
      + " is not defined.";
  }
  ...
  */
  ...
  template<class T>
  inline void Street<T>::SetMeteoAerosol(T liquidwatercontent)
  {
  ...
  */
  template<class T>
  inline void Street<T>::SetStreetSurfaceDepositedMass(T street_surface_deposited_mass, int s)
  {
    street_surface_deposited_mass_(s) = street_surface_deposited_mass;
  }
  ...
  */
  ...
  template<class T>
  inline T Street<T>::GetStreetSurfaceDepositedMass(int s) const
  {
    return street_surface_deposited_mass_(s);
  }
...
#define POLYPHEMUS_FILE_MODELS_STREETTRANSPORTINERTPARTICLE_CXX
#endif
