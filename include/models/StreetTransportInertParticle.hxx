#ifndef POLYPHEMUS_FILE_MODELS_STREETTRANSPORTINERTPARTICLE_HXX
...
namespace Polyphemus
{
  ...
  protected:
    ...
    Array<T, 1> street_surface_deposited_mass_;
  ...
  public:
    ...
    virtual void SetMeteoChemistry(T attenuation, T specific_humidity);
    T GetpH() const;
    ...
    //aerosol------------------------------------------
    virtual T GetRelativeHumidity() const;
    virtual void SetRelativeHumidity(T relative_humidity);
    ...
    virtual void SetMeteoAerosol(T liquidwatercontent);
    ...
    void SetStreetSurfaceDepositedMass(T street_surface_deposited_mass_aer, int s);
    ...
    T GetStreetSurfaceDepositedMass(int s) const;
...
#define POLYPHEMUS_FILE_MODELS_STREETTRANSPORTINERTPARTICLE_HXX
#endif
